<div class="modal fade" id="modal-acao-notas" tabindex="-1" aria-labelledby="exampleModalLabel"
    aria-hidden="true">
            ...
            <div class="modal-content">
                ...
                <div class="modal-body">
                        <select class="custom-select" name='editar'>
                            <option value="1">Marcar recebida</option>
                            <option value="2">Marcar finalizada</option>
